...
export default function DijitalOfisContent() {
  return (
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_1fr]">
              <div className="max-w-[720px]">
                ...
                <div className="mt-7 lg:hidden">
                  <div className="relative h-[250px] w-full overflow-hidden rounded-[30px]">
                    <Image src="/hero_male.png" alt="Dijital Ofis" fill className="object-cover object-top" sizes="100vw" priority />
              ...
              <div className="hidden items-end justify-center lg:flex">
                <div className="relative h-[380px] w-full overflow-hidden rounded-[32px]">
                  <Image src="/hero_male.png" alt="Dijital Ofis" fill className="object-cover object-top" sizes="(max-width: 1280px) 50vw, 560px" priority />
