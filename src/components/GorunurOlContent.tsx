...
export default function GorunurOlContent() {
  return (
    <main className="bg-white pt-[92px]">
      ...
      {/* ─── HİZMETLER ─── */}
      <section id="hizmetler" className="px-6 py-16 bg-[#F5F7FA]">
        <div className="mx-auto max-w-[1230px]">
          <motion.div
            ...
            {serviceCards.map((card, i) => {
              ...
              return (
                ...
                >
                  <Link
                    href={card.href}
                    className={`group rounded-[32px] border ${card.border} ${card.bg} p-10 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl flex flex-col`}
                  >
                    <div
          ...
          <motion.div
            ...
            className="mt-6 rounded-[28px] border border-dashed border-black/15 bg-white p-10 opacity-70"
          >
